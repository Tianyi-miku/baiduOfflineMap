...
(function (bj, es) {
  ...
  C.Dom.getOffset = function (hI) {
    ...
    if (hI.getBoundingClientRect) {
      ...
      hM.left =
        hJ.left + Math.max(hL.documentElement.scrollLeft, hL.body.scrollLeft);
      hM.top =
        hJ.top + Math.max(hL.documentElement.scrollTop, hL.body.scrollTop);
      ...
      if (hL.getBoxObjectFor && !hK) {
        ...
        if (
          C.isOpera > 0 ||
          (C.isWebkit > 0 && C.Dom.getStyle(hI, "position") == "absolute")
        ) {
  ...
  C.G = function () {
    for (var T = [], hI = arguments.length - 1; hI > -1; hI--) {
      ...
      if (typeof hJ == "object" && hJ && hJ.dom) {
        ...
        if (
          (typeof hJ == "object" && hJ && hJ.tagName) ||
          hJ == window ||
          hJ == document
        ) {
          T[hI] = hJ;
  ...
  C.hasClass = function (hI, T) {
    ...
    try {
      i =
        hI.className == T ||
        hI.className.search(new RegExp("(\\s|^)" + T + "(\\s|$)"));
    } catch (hJ) {
      return false;
    }
    return i > -1;
  ...
  if (
    ...
    try {
      HTMLElement.prototype.__defineGetter__("children", function () {
        for (
          var T = [], hI = 0, hK, hJ = 0, e = this.childNodes.length;
          hJ < e;
          hJ++
        ) {
  ...
  for (var gj in C.Platform) {
    if (C.Platform.hasOwnProperty(gj)) {
      C.Platform[gj] = new RegExp(gj, "i").test(window.navigator.userAgent)
        ? 1
        : 0;
    }
  }
  ...
  eN.imgResources = {
    ...
    markerPng:
      eN.staticHost + "/res/litemapapi/v1d1/images/marker.png?20170501",
    locPng: eN.staticHost + "/res/litemapapi/v1d1/images/loc.png?20180918",
    locNewPng:
      eN.staticHost + "/res/litemapapi/v1d1/images/loc_new.png?20190314",
    zoomPng: eN.staticHost + "/res/litemapapi/v1d1/images/zoombtn.png?20180918",
    mapLogoPng:
      eN.staticHost + "/res/litemapapi/v1d1/images/logo-2x.png?20190226",
  };
  var eV = eN;
  var aY = "ruler.cur";
  ...
  C.extend(c2.prototype, {
    ...
    _setConfig: function (i) {
      ...
      this.config = {
        ...
        defaultMaxBounds: new dM(
          new hj(-21364736, -10616832),
          new hj(23855104, 15859712)
        ),
        showControls: false,
    ...
    getBoundsIn: function () {
      ...
      var hZ =
        typeof hV.heading === "number" ? hV.heading : this._heading % 360;
      ...
      var id = Math.sqrt(
        Math.pow(hY.lng - hI[0], 2) + Math.pow(hY.lat - hI[1], 2)
      );
      ...
      var hW = this.pixelToPointIn(
        { x: this.width - hJ[1], y: this.height - hJ[2] },
        hV
      );
      var h4 = [h7, ib, hY, hW];
      var ia = h4[0].lng;
    ...
    getSolarInfo: function (hI) {
      ...
      var hJ = Math.asin(
        (Math.sin(dE(hM)) * Math.cos(dE(hQ.lat))) / Math.cos(hK)
      );
      var i = "north";
      if (hL.lat < hQ.lat) {
        i = "south";
    ...
    getCurrentMaxTilt: function () {
      ...
      if (e >= 19) {
        ...
        if (e <= 18) {
          ...
          return (
            (c2.MAX_DRAG_TILT - c2.MAX_DRAG_TILT_L2) * (e - 18) +
            c2.MAX_DRAG_TILT_L2
          );
        }
      }
    ...
    getViewport: function (hK, hI) {
      ...
      if (hK && hK.length) {
        ...
        if (hK instanceof dM) {
          T = new dM(
            ef.convertLL2MC(hK.getSouthWest()),
            ef.convertLL2MC(hK.getNorthEast())
          );
          T.setMinMax();
        }
      }
    ...
    getBounds: function () {
      ...
      var i = new dM(
        ef.convertMC2LL(e.getSouthWest()),
        ef.convertMC2LL(e.getNorthEast())
      );
      return i;
    },
  ...
  var f = {
    ...
    getStyleUrl: function (T, hJ, hI, e) {
      this.styleJson = T;
      var i =
        eV.apiHost + "/custom/v2/mapstyle?version=" + 4 + "&ak=" + hJ + "&";
      i += "is_all=true&is_new=1&";
      i += "styles=" + encodeURIComponent(this.styleJson2styleStringV2(T, e));
      i =
        offmapcfg.customstyle.length > 0
          ? offmapcfg.customstyle
          : offmapcfg.home + "customstyle/mapstyle";
      return i;
    },
    styleJson2styleStringV2: function (e, hN) {
      ...
      for (var hI = 0; !!e[hI]; hI++) {
        ...
        if (
          hP.featureType === "roadarrow" &&
          hP.elementType === "labels.icon" &&
          hP.stylers
        ) {
    ...
    addDrawIntoAreaSpots: function (e, hJ) {
      ...
      for (var T = 0; T < hJ.styleIds.length; T++) {
        ...
        this.map.addAreaSpot(hL, {
          userData: { styleId: hJ.styleIds[T], type: "mapstyle" },
        });
      }
    },
        ...
        if (!bq()) {
          ...
          if (this.isIOS112()) {
            ...
            var e = new Uint8Array([
              ...
              1, 127, 3, 130, 128, 128, 128, 0, 1, 0, 4, 132, 128, 128, 128, 0,
              1, 112, 0, 0, 5, 131, 128, 128, 128, 0, 1, 0, 1, 6, 129, 128, 128,
              128, 0, 0, 7, 145, 128, 128, 128, 0, 2, 6, 109, 101, 109, 111,
              114, 121, 2, 0, 4, 109, 97, 105, 110, 0, 0, 10, 138, 128, 128,
  ...
  function gQ(e) {
    return (
      bb(e) - (0.00569 + 0.00478 * Math.sin((125.04 - 1934.136 * e) * aL)) * aL
    );
  }
  function bb(e) {
    return ai(e) + dL(e);
  ...
  function da(hR, hM) {
    ...
    for (var hL = 0, hK = hM.length - 2; hL < hM.length; hL += 2) {
      ...
      var T = hM[hK + 1];
      var e =
        hJ > hP !== T > hP && hQ < ((hN - hO) * (hP - hJ)) / (T - hJ) + hO;
      if (e) {
        hI = !hI;
      }
      hK = hL;
  ...
  !(function (i, T) {
    ...
    function iw(e) {
      return iH(
        ...
        function (i, T) {
          return (
            (T - i - (T.getTimezoneOffset() - i.getTimezoneOffset()) * io) / iE
          );
        }
      );
    }
    ...
    var iL = iC.range,
      ...
      h6 = iH(
        ...
        function (i, T) {
          return (
            (T - i - (T.getTimezoneOffset() - i.getTimezoneOffset()) * io) / iy
          );
        },
        function (e) {
          return e.getDate() - 1;
      ...
      if (hI.addEventListener) {
        ...
        if (hI.attachEvent) {
          hI.attachEvent("onreadystatechange", function (hM) {
            ...
            if (
              hL &&
              (hL.readyState === "loaded" || hL.readyState === "complete")
            ) {
              hL.parentNode.removeChild(hL);
            }
            T && T();
  ...
  a3.ifSupportWebGL = function () {
    ...
    if (hJ === null) {
      ...
      if (
        hJ.drawingBufferWidth !== T.width ||
        hJ.drawingBufferHeight !== T.height
      ) {
        i._supportWebGL = false;
      }
      ...
      if (
        ...
        hJ.getShaderPrecisionFormat(hJ.FRAGMENT_SHADER, hJ.HIGH_FLOAT)
          .precision < 23
      ) {
        i._supportWebGL = false;
      }
  ...
  var cv = {
    request: function (hL, hI, i, hN, T) {
      ...
      var hK = this;
      var e =
        eV.apiHost + "/" + hN + "?" + hM + "&ie=utf-8&oue=1&fromproduct=jsapi";
      if (!T) {
        e += "&res=api";
      }
      ...
      if (e.addEventListener) {
        ...
        if (e.attachEvent) {
          e.attachEvent("onreadystatechange", function (hJ) {
            ...
            if (
              hI &&
              (hI.readyState == "loaded" || hI.readyState == "complete")
            ) {
              hI.parentNode.removeChild(hI);
            }
          });
  ...
  C.extend(dB.prototype, {
    ...
    addCopyright: function (hI) {
      ...
      if (this._map) {
        ...
        if (
          hL === -1 ||
          hL < this._map.getMinZoom() ||
          hL > this._map.getMaxZoom()
        ) {
  ...
  gs.prototype._render = function () {
    ...
    this._div.style.height =
      parseInt(this._floorsContainer.style.height, 10) + hN + "px";
  ...
  gs.prototype._adjustDisplayHeight = function () {
    ...
    var hN = hJ - 1;
    this._div.style.height =
      parseInt(this._floorsContainer.style.height, 10) + hO + "px";
  ...
  C.extend(ca.prototype, {
    ...
    removeSeparator: function (T) {
      ...
      for (var hI = 0, e = this._items.length; hI < e; hI++) {
        if (
          this._items[hI] &&
          this._items[hI]._type == "divider" &&
          this._items[hI]._dIndex == T
        ) {
  ...
  C.extend(ef, {
    ...
    getDistance: function (i, e, hI, T) {
      return (
        this.EARTHRADIUS *
        Math.acos(
          Math.sin(hI) * Math.sin(T) +
            Math.cos(hI) * Math.cos(T) * Math.cos(e - i)
        )
      );
    },
  ...
  function dk(e, i) {
    ...
    this.setConfig(i);
    if (!i.icon) {
      this._config.icon = new g2(
        eV.imgPath + "marker_red.png",
        new d1(23, 25),
        { offset: new d1(10, 25), infoWindowOffset: new d1(10, 0) }
      );
    }
  ...
  C.extend(a.prototype, {
    ...
    calcMiddlePoint: function (hP, hO, hQ, hU) {
      ...
      var hM =
        hX * Math.cos(hV) * Math.cos(i) + hW * Math.cos(hS) * Math.cos(e);
      var hL =
        hX * Math.cos(hV) * Math.sin(i) + hW * Math.cos(hS) * Math.sin(e);
    ...
    calcAngularDistance: function (hJ, i) {
      ...
      var e = dE(i.lng);
      return Math.acos(
        Math.sin(hK) * Math.sin(hI) +
          Math.cos(hK) * Math.cos(hI) * Math.cos(Math.abs(e - T))
      );
    },
  });
  function aj(hJ, e) {
  ...
  C.extend(fZ.prototype, {
    ...
    _getPerimeterPoints: function (e, hP) {
      ...
      for (var hN = 0; hN < 360; hN += 9) {
        ...
        var hS = Math.asin(
          Math.sin(hO) * Math.cos(hR) +
            Math.cos(hO) * Math.sin(hR) * Math.cos(hL)
        );
        var hQ = Math.atan2(
      ...
      if (hI) {
        this._radiusMercator = Math.sqrt(
          Math.pow(hI.lng - this.point.lng, 2) +
            Math.pow(hI.lat - this.point.lat, 2)
        );
      } else {
  ...
  var bC = {
    B_NORMAL_MAP: {
      ...
      bounds: new dM(
        new hj(-21364736, -11708041.66),
        new hj(23855104, 12474104.17)
      ),
      imgExtend: "png",
    },
    B_SATELLITE_MAP: {
      ...
      if (this.opts.tileUrlTemplate) {
        ...
        if (this.mapType == BMAPGL_NORMAL_MAP) {
          ...
          i =
            ...
            hO;
          var tdir =
            offmapcfg.tiles_road_dir.length > 0
              ? offmapcfg.tiles_road_dir
              : offmapcfg.home + "tiles";
        ...
        if (this.mapType == BMAP_SATELLITE_MAP) {
          ...
          i =
            ...
            hM;
          var tdir =
            offmapcfg.tiles_satellite_dir.length > 0
              ? offmapcfg.tiles_satellite_dir
              : offmapcfg.home + "tiles_satellite";
          i = tdir + "/" + e + "/" + hI + "/" + hQ + offmapcfg.imgext;
        }
      }
      return i;
  ...
  C.extend(ah.prototype, {
    ...
    prepareLabelLayer: function () {
      ...
      if (this._enableCanvas2dMap && hJ.canvas2dMapMgr) {
        ...
        e.drawImage(i, 0, 0);
        hJ.platform.insertBefore(
          this.touchZoomLabelCanvas,
          hJ.platform.firstChild
        );
    ...
    preComputeLabel: function (hO, iI, iq, h0, iC, iW) {
      ...
      if (iB) {
        ...
        for (var ig = 0, ib = ij.length; ig < ib; ig++) {
          ...
          delete hP._tempRank;
          if (
            !this._canvas2dMapMgr.isClickableLabel(hP) ||
            (h7 === 1 && !hP.guidExt)
          ) {
            continue;
          }
  ...
  C.extend(ag.prototype, {
    ...
    _getLabelId: function (i, hI, T, e) {
      return (
        "_" + i + "_" + hI + "_" + T + "_" + e + "_" + this.labelStyleParam
      );
    },
    ...
    _loadData: function (hU) {
      ...
      this._curViewLabels = [];
      var hI =
        "viewKey_" + Math.floor(hN.lng) + "_" + Math.floor(hN.lat) + "_" + h2;
      this.statRequestCount = 0;
      this.statResponseCount = 0;
    ...
    _loadLabelData: function (hR, hQ, hP, T, hS, e) {
      ...
      var tiles_dir =
        offmapcfg.tiles_v_road_dir.length > 0
          ? offmapcfg.tiles_v_road_dir
          : offmapcfg.home + "tiles_v_road";
    ...
    _addSpotData: function () {
      ...
      for (var hK = 0, hJ = this._computedLabel.length; hK < hJ; hK++) {
        ...
        if (
          !this.isClickableLabel(hM) ||
          (hM.guidExt === 1 && hM.startScale > hP)
        ) {
          continue;
        }
        var hL = [];
        ...
        if (
          hM.iconPos &&
          hM.iconPos.iconType.indexOf("ditie") > -1 &&
            ...
            if (hL && h4 <= e) {
              ...
              if (T) {
                ...
                if (!T) {
                  ...
                  ia.src =
                    eV.getIconSetPath(h8._map.config.style) +
                    hL.iconType +
                    ".png";
                }
              }
        ...
        if (iF.isDel == false) {
          ...
          if (iF.type == "fixed") {
            ...
            for (var iJ = 0, iu = h0.length; iJ < iu; iJ++) {
              ...
              var h5 = iB.angle;
              var it = Math.round(
                (iy + (iP - iy) * hI) * iD - hS.width / 2 + iR - hO
              );
              var ir = Math.round(
                (ix + (iM - ix) * hI) * iD - hS.height / 2 + iQ - hM
              );
              hN = it;
              hK = ir;
              hP = iB.width;
  ...
  C.extend(c1.prototype, {
    ...
    _ifUseAnimation: function (hI, hN) {
      ...
      if (
        (hK > hM.width || i > hM.height) &&
        (e > hM.width || hQ > hM.height)
      ) {
        return false;
      }
      return true;
  ...
  var fK = {
    ...
    getTilesUrl: function (hJ, hS, hT) {
      ...
      var tiles_dir =
        offmapcfg.tiles_v_dir.length > 0
          ? offmapcfg.tiles_v_dir
          : offmapcfg.home + "tiles_v";
    ...
    getRasterTilesUrl: function (T, hK, hI) {
      ...
      var e =
        ...
        (i === "default" || typeof i !== "string"
          ? ""
          : "&styleId=" + eV.mapStyleNameIdPair[i]) +
        "&styles=pl&udt=" +
        this.normalUdt +
        "&scaler=" +
        this.scaler +
    ...
    loadVectorLayerData: function (hO) {
      ...
      function hM(i, hP) {
        ...
        if (!i || i.error) {
          ...
          hN.getVectorLayerDataFromCache(
            hN.curViewTilesInfo,
            hN.getZoomState()
          );
          return;
      ...
      bj[hJ] = function (hO) {
        var hP = (function (hQ) {
          return function () {
              ...
              for (var hU = 0; hU < hY.length; hU++) {
                ...
                if (hZ.length / 7 + h0[0].length / 2 > 65536) {
                  hT.renderData.base.push({
                    type: "line",
                    data: [
                      e9.toTileSolidLineVertices(hZ, 4000),
                      new Uint16Array(h2),
                    ],
                  });
                  hZ = [];
            ...
            hI.getVectorLayerDataFromCache(
              hI.curViewTilesInfo,
              hI.getZoomState()
            );
      ...
      for (var hN = 0; hN < hV.length; hN++) {
        ...
        for (var hO in hU.indoorData) {
          ...
          if (e.floors[hJ]) {
            ...
            if (e.floors[hJ].pois) {
              hM.label.indoorLabel = hM.label.indoorLabel.concat(
                e.floors[hJ].pois
              );
            }
          }
    ...
    mergeSameZoomLabelData: function (hL) {
      ...
      if (hK.renderData.indoorData && hL.renderData.indoorData) {
        this.mergeIndoorLabelData(
          hL.renderData.indoorData,
          hK.renderData.indoorData
        );
      }
    },
  ...
  C.extend(v.prototype, {
    ...
    drawLabelsOnCanvas: function (h0, hI) {
      ...
      for (var hY = 0; hY < hQ.length; hY++) {
        ...
        if (
          hP.textOnIcon &&
          (!this._iconCache[hJ] || this._iconCache[hJ].loaded === false)
        ) {
          hU.push(hP);
          h4++;
          if (!hT[hJ]) {
        ...
        for (var hS = 0; hS < hN.length; hS++) {
          ...
          for (var hR = 0; hR < hL.length; hR++) {
            if (hP === null && hL[hR].styleText[0]) {
              hP =
                hL[hR].styleText[0].fontSize + hL[hR].styleText[0].haloSize * 2;
              hM = hP;
            }
            hU.push(hL[hR]);
          }
  ...
  C.extend(dd.prototype, {
      ...
      T.addEventListener("spotclick", function (hK) {
        if (hK.spots && hK.spots.length > 0) {
          ...
          if (
            ...
            (i.currentSelectedLabel.uid !== hJ ||
              i.currentSelectedLabel.tilePosStr !== hL)
          ) {
    ...
    getLabelByUid: function (hL, hM) {
      ...
      for (var hK = 0; hK < e.length; hK++) {
        ...
        for (var hJ = 0; hJ < T.length; hJ++) {
          if (
            e[hK].fixedLabel[hJ].guid === hL &&
            e[hK].fixedLabel[hJ].tilePosStr === hM
          ) {
        ...
        for (var hJ = 0; hJ < hI.length; hJ++) {
          if (
            e[hK].indoorLabel[hJ].guid === hL &&
            e[hK].indoorLabel[hJ].tilePosStr === hM
          ) {
    ...
    _addToIconTexture: function (hK) {
      ...
      var hL = hP;
      var i = T;
      hM._iconTextureAtlasCoords[hK.id] = [
        hP,
        hJ,
        hO,
        hI,
        ...
        if (hK && hK.rtVertex) {
          if (!hL[i].formatedData) {
            T = {
              ...
              textureSource:
                hO.textureSources && hL[i].processedInZoom
                  ? hO.textureSources[hL[i].processedInZoom]
                  : "",
              textureHeight:
                hO.textureHeights && hL[i].processedInZoom
                  ? hO.textureHeights[hL[i].processedInZoom]
                  : "",
            ...
            if (hN && hL[i].onDefaultFloor === false) {
              T.textureSource =
                hO.indoorTextureSources && hL[i].processedInZoom
                  ? hO.indoorTextureSources[hL[i].processedInZoom]
                  : "";
              T.textureHeight =
                hO.indoorTextureHeights && hL[i].processedInZoom
                  ? hO.indoorTextureHeights[hL[i].processedInZoom]
                  : "";
            }
            hL[i].formatedData = T;
      ...
      if (hI) {
        ...
        if (!hI.isSendFS) {
          if (!f0["stringifiedFeatureStyle" + hM] && bj["FeatureStyle" + hM]) {
            f0["stringifiedFeatureStyle" + hM] = JSON.stringify(
              bj["FeatureStyle" + hM]
            );
          }
          if (!f0["stringifiedIconSetInfo" + hK]) {
            f0["stringifiedIconSetInfo" + hK] = JSON.stringify(
              bj["iconSetInfo" + hK]
            );
          }
          ...
          if (hL && bj.customStyleInfo) {
            if (!f0.stringifiedCustomStyleInfo) {
              f0.stringifiedCustomStyleInfo = JSON.stringify(
                bj.customStyleInfo
              );
            }
          }
  ...
  var b9 = (function () {
    ...
    i.getTilesUrl = function (hO, hP) {
      ...
      var hQ = hO.y;
      var hM =
        hL + "?qt=vtraffic&z=" + hP + "&x=" + hN + "&y=" + hQ + "&udt=" + T;
      return hM;
    };
